...
do
	...
	'--neural-model')
	    ...
	    ;;
	'--device')
	    qubo_opts="$qubo_opts --device $2"
	    shift 2
	    continue
	    ;;
	'--neural-beta')
	    qubo_opts="$qubo_opts --neural-beta $2"
	    shift 2
	    continue
	    ;;
	'--subgraph')
...
do
    ...
    # Creates:
    #     $i.path
    qubo_solvers="mqlib gurobi dwave exact local greedy_residual random_residual_walk beam_search aco neural_aco astar seea"
